...
<template>
  <DenomUnitConverter :internalDenom="pool.base.denom" :internalAmount="pool.base.balance">
    <template
      v-slot="{
        displayDenom: baseDisplayDenom,
        displayAmount: baseDisplayAmount,
        displayName: baseDisplayName,
        displayDescription: baseDisplayDescription,
      }"
    >
        ...
        <template v-slot="{ displayDenom: quoteDisplayDenom, displayAmount: quoteDisplayAmount }">
          <div class="flex">
            <div class="grow">
              ...
              <div
                class="stats shadow stats-vertical xl:stats-horizontal bg-base-200 grow w-full flex"
              >
                <div class="stat">
                  <div class="stat-value uppercase">{{ baseDisplayName || baseDisplayDenom }}</div>
                  <div class="stat-title">{{ baseDisplayDescription }}</div>
                ...
                <div class="stat">
                  <div class="stat-title">1 {{ baseDisplayDenom }} ≃</div>
                ...
                <div class="stat">
                  <div class="stat-title">1 {{ quoteDisplayDenom }} ≃</div>
                  <div class="stat-value truncate">
                    {{
                      (baseDisplayAmount / quoteDisplayAmount).toLocaleString(undefined, {
                        notation: 'standard',
                        maximumSignificantDigits: 3,
                      })
                    }}
